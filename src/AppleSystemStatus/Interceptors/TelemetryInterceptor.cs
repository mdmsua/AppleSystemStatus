...
namespace AppleSystemStatus.Interceptors
{
    internal class TelemetryInterceptor : DbCommandInterceptor
    {
        ...
        {
            telemetryClient.TrackDependency(dependencyType, eventData.CommandId.ToString(), eventData.Command.CommandText, eventData.StartTime, eventData.Duration, true);
            return result;
        }

        public override void CommandFailed(DbCommand command, CommandErrorEventData eventData)
        {
            telemetryClient.TrackDependency(dependencyType, eventData.ExecuteMethod.ToString(), eventData.Command.CommandText, eventData.StartTime, eventData.Duration, false);
        }
