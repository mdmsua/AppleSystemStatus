...
{
    public partial class Fenix : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(nullable: false, maxLength: 8)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: false, maxLength: 96),
                    CountryId = table.Column<string>(nullable: false, maxLength: 8),
